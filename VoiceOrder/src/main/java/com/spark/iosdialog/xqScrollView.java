...
public class xqScrollView extends ScrollView {
	private static final String TAG = "xqScrollView";
	...
	public xqScrollView(Context context) {
		super(context);
		mContext = context;
	}

	public xqScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		DRAG_X_THROD = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30,
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		switch (action) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if ((dy > DRAG_X_THROD) && (dx < DRAG_X_THROD)) {
					isUpDown = true;
				}
