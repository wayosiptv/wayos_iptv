...
//                            }
    ...
    public static void DownApp(Activity activity,String apkPath,String serverVersionName) {
        DownloadAppUtils.download(activity, apkPath, serverVersionName);

    }public static void DownApp1(Context mContext,String apkPath,String serverVersionName) {
        DownloadAppUtils.download(mContext, apkPath, serverVersionName);
    }
