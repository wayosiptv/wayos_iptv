...
public class WelDcAdapter extends BaseAdapter {
    private Context mContext;
    private List<WelMenuData.DataBean> mDataBen = new ArrayList<>();
    public boolean englishFlag = false;

    public WelDcAdapter(Context mContext, List<WelMenuData.DataBean> mDataBen) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.wel_page_grid_item_dc_1, null);
            holder.menuText = (TextView) view.findViewById(R.id.menuText1);
            holder.menuIcon = (ImageView) view.findViewById(R.id.menuIcon1);
            view.setTag(holder);
        } else {
