...
public class WelImgAdapter extends BaseAdapter {
    private Context mContext;
    private List<WelMenuData.DataBean> mDataBen = new ArrayList<>();


    public WelImgAdapter(Context mContext, List<WelMenuData.DataBean> mDataBen) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.wel_page_grid_item_img_7, null);
            holder.menuIcon = (ImageView) view.findViewById(R.id.menuIcon7);
            holder.menuText = (TextView) view.findViewById(R.id.menuText7);
            view.setTag(holder);
        } else {
